...
public class ThirdPersonCharacter_Sync : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    bool preventStanding = false;
	[SerializeField]
	bool preventCrouch = false;
    ...
    public void Move(Vector3 move, bool crouch, bool jump, Vector3 lookPos)
    {
		...
		if (ragdollHelper.ragdolled || CanMove == false)
            return;
    ...
    public void OnAnimatorMove()
    {
        ...
        if (animator && GetComponent<Rigidbody>())// && !rigidbody.isKinematic)
        {
